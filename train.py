...
class Trainer(object):
    ...
    def compute_loss(self, labels, outputs):
        ...
        for output in outputs:
            ...
            # print('AAAA', tf.divide(output, labels)*100)
        return loss
    ...
    def train_step(self, inputs):
        ...
        # self.train_acc_metric.update_state(labels, outputs)
    ...
    def run(self, train_dist_dataset, val_dist_dataset):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            ...
            # print("Training acc over epoch:", train_acc_metric)
            # train_acc = self.train_acc_metric.result()
            # print("Training acc over epoch:", train_acc)
            # tf.print("a:", train_acc)
            # tf.summary.scalar('epoch val loss', train_acc)
            # losses_val.append(val_loss.numpy())
